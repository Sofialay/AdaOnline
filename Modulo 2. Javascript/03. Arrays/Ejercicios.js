...
const nombres = ['Ada', 'Greta', 'Grace'];
const pregunta = prompt("Ingrese su nombre");
if (nombre = 'Ada' || 'Greta' || 'Grace') {
...
const pregunta = prompt("Ingrese los numeros 5 7 99 34 54 2 12 para acomodarlos")
const resultado = numeros.sort();
console.log(numeros);      /// funciona pero los desacomoda, intentar de nuevo buscar sort();
 ...
 */
 ...
 if (miArray.length === 1) {
     ...
     alert(`${miArray[0]} y ${miArray[1]} están conectadas`);
 }else {
